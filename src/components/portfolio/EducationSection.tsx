...
const EducationSection = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      date: "2025",
      type: "Completion Certificate",
      description: "Completed a structured certification program in Data Structures and Algorithms, solving 150+ problems and gaining strong problem-solving skills coding interviews..",
